            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <a class="btn btn-box-tool blue-col" href="{{ route('prodi.berita.acara.skripsi') }}">
                ...
                {{ Form::open(array('id' => 'frm', 'url' => route('prodi.berita_acara_isi_form.skripsi', $participant->id), 'method' => 'POST')) }}
                    <div class="box-body">
    ...
    function bindOnInputScore() {
        ...
        $('#nilai_score').on('input', function() {
            ...
            if(nilai >= 80.00 && nilai <= 100.00) {
                indexs = 'A';
                ip = '4.00';
            } else if(nilai >= 68.00 && nilai <= 79.99) {
                indexs = 'B';
                ip = '3.00';
            } else if(nilai >= 56.00 && nilai <= 67.99) {
                indexs = 'C';
                ip = '2.00';
            } else if(nilai >= 45.00 && nilai <= 55.99) {
                indexs = 'D';
                ip = '1.00';
            } else if(nilai >= 0.00 && nilai <= 44.99) {
                indexs = 'E';
                ip = '0.00';
            }
