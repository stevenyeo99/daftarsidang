            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <a class="btn btn-box-tool blue-col" href="{{ route('prodi.berita.acara.kp') }}">
                ...
                {{ Form::open(array('id' => 'frm', 'url' => route('prodi.berita_acara_isi_form.kp', $participant->id), 'method' => 'POST')) }}
                    <div class="box-body">
                        ...
                        @if($participant->participant_type == 1)    
                            <br>
                            <hr>
                            <h4><u><b>Nilai kerja Praktek</b></u></h4>
