            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="dtBeritaAcaraKP" class="data-table table table-bordered table-hover">
                            <thead>
                                <tr role="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        var dtBeritaAcaraKP = $('#dtBeritaAcaraKP').DataTable({
            'autoWidth': false,
            orderCellsTop: true,
            responsive: false,
            processing: true,
            ...
            ajax: {
                url: '{{ route('prodi_admin.berita_acara_kp_list') }}',
                data: function(data) {
        ...
        .on('change', function() {
            ...
            var v = $(this).val();
            dtBeritaAcaraKP.columns(i).search(v).draw();
        });
