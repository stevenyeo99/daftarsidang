            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="dtPenjadwalanTesis" class="data-table table table-bordered table-hover">
                            <thead>
                                <tr role="row">
...
@push('custom_js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dtPenjadwalanTesis = $('#dtPenjadwalanTesis').DataTable({
                'autoWidth': false,
                orderCellsTop: true,
                responsive: false,
                processing: true,
                ...
                ajax: {
                    url: '{{ route('prodi.penjadwalan_tesis_list') }}',
                    data: function(data) {
            ...
            .on('change', function() {
                ...
                var v = $(this).val();
                dtPenjadwalanTesis.columns(i).search(v).draw();
            });
