                        ...
                        <table id="student_datatable" class="data-table table table-bordered table-hover">
                            <thead>
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        {{ Form::text('email', null, ['id' => 'email', 'class' => 'width-100p form-control form-filter input-sm search-input-text', 'data-column' => '2']) }}
                                    </td>
                                    <td>
                                        {{ Form::text('phone_number', null, ['id' => 'phone_number', 'class' => 'numeric-field width-100p form-control form-filter input-sm search-input-text', 'data-column' => '3']) }}
                                    </td>
                                    <td>
                                        {{ Form::select('semester_type', $semester_types, null , ['id' => 'semester_type', 'class' => 'form-control form-filter input-sm select2 search-input-select', 'placeholder' => 'All', 'data-column' => '4']) }}
                                    </td>
                                    <td>
                                        {{ Form::text('study_program_name', null, ['id' => 'study_program_name', 'class' => 'width-100p form-control form-filter input-sm search-input-text', 'data-column' => '5']) }}
                                    </td>
                                </tr>
                            </thead>
                            <tbody></tbody>
        ...
        $(document).ready(function() {
            var studentDatatable = $('#student_datatable').DataTable(
            {
                ...
                columns: [
                    ...
                    { data: 'semester_type', name: 'semester_type', "width": "120px" },
