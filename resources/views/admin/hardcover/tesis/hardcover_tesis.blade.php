    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-body">
                    <!-- export hardcover tesis file -->
                    {{ Form::open(array('url' => route('admin.hardcovertesis.download'))) }}
                    ...
                    <div class="table-responsive">
                        <table id="hardcover_tesis_datatable" class="data-table table table-bordered table-hover">
                            <thead>
                                <tr role="row">
...
@push('custom_js')
    <script type="text/javascript">
        $(document).ready(function() {
            var hardcover_tesis_datatable = $('#hardcover_tesis_datatable').DataTable(
            {
                'autoWidth' : false,
                orderCellsTop: true,
                responsive: false,
                ...
                ajax: {
                    url: '{{ route('admin.hardcover_tesis.list') }}',
                    data: function(data) {
            ...
            $('.search-input-text').on('keyup click', function() { // for text boxes
                ...
                hardcover_tesis_datatable.columns(i).search(v).draw();
            });  
