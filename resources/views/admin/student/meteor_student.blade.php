                        ...
                        <table id="student_datatable" class="data-table table table-bordered table-hover">
                            <thead>
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        {{ Form::text('program_study', null, ['id' => 'program_study', 'class' => 'width-100p form-control form-filter input-sm search-input-text', 'data-column' => '5']) }}
                                    </td>
                                </tr>
                            </thead>
                            <tbody></tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var studentDatatable = $('#student_datatable').DataTable(
            {
                ...
                ajax: {
                    url:  isSkripsiPage ? '{{ route('skripsi.student.list') }}' : '{{ route('tesis.student.list') }}',
                    data: function(data) {
