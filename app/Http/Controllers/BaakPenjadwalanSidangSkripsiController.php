...
class BaakPenjadwalanSidangSkripsiController extends MasterController {
    ...
    public function index() {
        ...
        return view('admin.schedule.skripsi', compact('breadcrumbs', 'title', 'sub_title', 'penjadwalan_css', 'jadwalSkripsi_css', 'arrRuangan')); 
    }

    /**
     * get list of penjadwalan skripsi data
     */
    public function getListOfPenjadwalanSkripsi() {
    ...
    /**
     * get button to display on datatabess baak penjadwalan sidang baak Skripsi
     */
    ...
    public function getRoute($key, $id = null) {
        switch($key) {
            case 'list':
                return route('baak.penjadwalan.skripsi');
            case 'view':
                return route('baak.penjadwalan.view.skripsi', $id);
            case 'jadwal':
                return route('baak.penjadwalan.assign.skripsi', $id);
            case 'undangan':
                return route('baak.penjadwalan.invitation.skripsi', $id);
            default:
                break;
        }
    }
    ...
    public function getPenjadwalanForStoreData(Jadwal $penjadwalan) {
        ...
        return view('admin.schedule.skripsi_schedule', compact('breadcrumbs', 'title', 'sub_title', 'penjadwalan_css', 'jadwalSkripsi_css', 'penjadwalan',
    ...
    public function viewPenjadwalan(Jadwal $penjadwalan) {
        ...
        $backRoute = route('baak.penjadwalan.skripsi');
        // dd($backRoute);
