...
class BaakPenjadwalanSidangKPController extends MasterController
{
    ...
    public function index() {
        ...
        return view('admin.schedule.kp', compact('breadcrumbs', 'title', 'sub_title', 'penjadwalan_css', 'jadwalKP_css', 'arrRuangan')); 
    }

    /**
     * get list of penjadwalan kp data
     */
    public function getListOfPenjadwalanKP() {
    ...
    public function getPenjadwalanForStoreData(Jadwal $penjadwalan) {
        ...
        return view('admin.schedule.kp_schedule', compact('breadcrumbs', 'title', 'sub_title', 'penjadwalan_css', 'jadwalKP_css', 'penjadwalan',
    ...
    public function viewPenjadwalan(Jadwal $penjadwalan) {
        ...
        $backRoute = route('baak.penjadwalan.kp');
        // dd($backRoute);
    ...
    /**
     * get button to display on datatabess baak penjadwalan sidang baak KP
     */
    ...
    public function getRoute($key, $id = null) {
        switch($key) {
            case 'list':
                return route('baak.penjadwalan.kp');
            case 'view':
                return route('baak.penjadwalan.view.kp', $id);
            case 'jadwal':
                return route('baak.penjadwalan.assign.kp', $id);
            case 'undangan':
                return route('baak.penjadwalan.invitation.kp', $id);
            default:
                break;
        }
    }
