...
class SidangInvitation extends Mailable {
    ...
    public function __construct(PenjadwalanSidang $jadwal, $template, RuanganSidang $ruangan) 
    {
        ...
        $this->prodi = $jadwal->request()->first()->student()->first()->studyprogram()->first()->name;
        $this->jadwal = $jadwal;
    ...
    public function build() {
        return $this->subject('Surat Undangan Sidang ' . $this->type)
            ->view('emails.requests.undangan_sidang')
